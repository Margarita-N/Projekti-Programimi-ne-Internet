...
function component($productname, $productprice, $productimg, $productid){
    ...
    <div class=\"col-md-3 col-sm-6 my-3 my-md-0\" style=\"padding-left: 20px; margin:40px\">
                <form action=\"index.php\" method=\"post\">
                    <div class=\"card shadow\">
                        <div>
                            <img src='$k' alt=\"Image1\" class=\"img-fluid card-img-top\">
                        </div>
                        <div class=\"card-body\">
                    ...
                    <div class=\"border rounded\">
                        <div class=\"row bg-white\">
                            <div class=\"col-md-3 pl-0\">
                                <img src=bookImg\\$productimg alt=\"Image1\" class=\"img-fluid\">
                            </div>
                            <div class=\"col-md-6\">
